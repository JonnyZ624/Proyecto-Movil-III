...
void main() => runApp(const Pagina3ca());

class Pagina3ca extends StatefulWidget {
  const Pagina3ca({super.key});

  @override
  State<Pagina3ca> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina3ca> {
  final List<String> listOfVideos = ["aVP5W58dF_k", "3vPbzEhF63s"];
  ...
  void initState() {
    super.initState();
    currentPlayingVideo = listOfVideos.removeAt(0); // El primer video se carga
  }
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: const AppBarTheme(
          backgroundColor: Colors.red, // Fondo rojo para el AppBar
          titleTextStyle: TextStyle(color: Colors.white), // Título blanco
        ),
      ),
      home: Scaffold(
        appBar: AppBar(
          title: const Text('The Incredibles 2'),
          leading: IconButton(
        ...
        body: Container(
          color: Colors.black87, // Fondo oscuro para la pantalla
          child: Column(
            ...
            children: [
              ...
              YoutubePlayerEmbed(
                ...
                customVideoTitle: "The Incredibles 2",
                autoPlay: false,
                ...
                children: [
                  ElevatedButton(
                    onPressed: videoController != null
                        ...
                        : null, // Habilitar solo si el controlador está disponible

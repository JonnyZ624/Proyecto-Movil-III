...
void main() => runApp(const Pagina2c1());

class Pagina2c1 extends StatefulWidget {
  const Pagina2c1({super.key});

  @override
  State<Pagina2c1> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina2c1> {
  final List<String> listOfVideos = ["UoSSbmD9vqc", "3vPbzEhF63s"];
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Interstellar',
      theme: ThemeData.dark().copyWith( // Aplica el tema oscuro para la app
        scaffoldBackgroundColor: Colors.black, // Fondo negro para la app
        appBarTheme: const AppBarTheme(
          backgroundColor: Colors.black, // Fondo negro en la barra de app
          iconTheme: IconThemeData(color: Colors.white), // Íconos blancos en la barra de app
        ),
      ),
      home: Scaffold(
        appBar: AppBar(
        ...
        body: Column(
          ...
          children: [
            ...
            const SizedBox(height: 50), // Espacio entre el video y los botones
            // Controles de video
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [

...
void main() => runApp(const Pagina2co());

class Pagina2co extends StatefulWidget {
  const Pagina2co({super.key});

  @override
  State<Pagina2co> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina2co> {
  final List<String> listOfVideos = ["snKUbRqyD5A", "3vPbzEhF63s"];

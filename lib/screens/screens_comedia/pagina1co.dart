...
void main() => runApp(const Pagina1co());

class Pagina1co extends StatefulWidget {
  const Pagina1co({super.key});

  @override
  State<Pagina1co> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina1co> {

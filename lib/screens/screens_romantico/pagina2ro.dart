...
void main() => runApp(const Pagina2ro());

class Pagina2ro extends StatefulWidget {
  const Pagina2ro({super.key});

  @override
  State<Pagina2ro> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina2ro> {
  final List<String> listOfVideos = ["7bwttaKGoBI", "3vPbzEhF63s"];

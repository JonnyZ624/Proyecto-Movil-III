...
void main() => runApp(const Pagina1dra());

class Pagina1dra extends StatefulWidget {
  const Pagina1dra({super.key});

  @override
  State<Pagina1dra> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina1dra> {
        ...
        body: Column(
          ...
          children: [
            ...
            YoutubePlayerEmbed(
              ...
              customVideoTitle: "The Shawshank Redemption",
              autoPlay: false,

...
void main() => runApp(const Pagina4dra());

class Pagina4dra extends StatefulWidget {
  const Pagina4dra({super.key});

  @override
  State<Pagina4dra> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina4dra> {
  final List<String> listOfVideos = ["SVCJptocl2g", "3vPbzEhF63s"];
        ...
        body: Column(
          ...
          children: [
            ...
            YoutubePlayerEmbed(
              ...
              customVideoTitle: "Schindlers List",
              autoPlay: false,

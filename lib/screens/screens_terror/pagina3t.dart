...
void main() => runApp(const Pagina3t());

class Pagina3t extends StatefulWidget {
  const Pagina3t({super.key});

  @override
  State<Pagina3t> createState() => _MyAppState();
}

class _MyAppState extends State<Pagina3t> {
  final List<String> listOfVideos = ["if6RlD38W6E", "3vPbzEhF63s"]; 
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('The Conjuring'), 
          leading: IconButton(
        ...
        body: Column(
          ...
          children: [
            ...
            YoutubePlayerEmbed(
              ...
              customVideoTitle: "The Conjuring", 
              autoPlay: false, 
